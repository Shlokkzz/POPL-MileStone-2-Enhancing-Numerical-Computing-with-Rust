...
//     let matrix_a: Array2<f64> = Array2::from_shape_fn((800, 800), |_| rng.sample(Uniform::new(0.0, 1.0)));
//     let matrix_b: Array2<f64> = Array2::from_shape_fn((800, 800), |_| rng.sample(Uniform::new(0.0, 1.0)));
